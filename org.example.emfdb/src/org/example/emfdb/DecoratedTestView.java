...
public class DecoratedTestView extends ViewPart {
	...
	public void createPartControl(Composite parent) {
		AddressBookImpl book = (AddressBookImpl)AddressbookFactory.eINSTANCE.createAddressBook();
		...
		IObservableList obList = EMFProperties.list(AddressbookPackage.Literals.ADDRESS_BOOK__PEOPLE)
			.observeDetail(v);
		...
		col.getColumn().pack();
		IObservableMap map = EMFProperties.value(AddressbookPackage.Literals.PERSON__FIRST_NAME).observeDetail(cp.getKnownElements());
