    ...
    public Object start(final IApplicationContext context) throws Exception {
        ...
        Realm.runWithDefault(SWTObservables.getRealm(display), new Runnable() {
            public void run() {
                ...
                Date end = new Date();
                System.out.printf("Domain initialization took %d milliseconds\n", end.getTime() - start.getTime());
                System.out.printf("Waiting for gobyte!\n");
                // Super-stupid "synchronization".  Wait until something has been presented on STDIN before continuing.
                try {
                    System.in.read();
                } catch (IOException e) {
                    e.printStackTrace();
