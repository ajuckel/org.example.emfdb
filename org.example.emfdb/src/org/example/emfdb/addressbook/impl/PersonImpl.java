 ...
 * <ul>
 * <li>{@link org.example.emfdb.addressbook.impl.PersonImpl#getFirstName <em>
 * First Name</em>}</li>
 * <li>{@link org.example.emfdb.addressbook.impl.PersonImpl#getLastName <em>Last
 * Name</em>}</li>
 * <li>{@link org.example.emfdb.addressbook.impl.PersonImpl#getPhoneNumbers <em>
 * Phone Numbers</em>}</li>
 * <li>{@link org.example.emfdb.addressbook.impl.PersonImpl#getScores <em>Scores
 * </em>}</li>
 * <li>{@link org.example.emfdb.addressbook.impl.PersonImpl#getTemperature <em>
 * Temperature</em>}</li>
 * <li>{@link org.example.emfdb.addressbook.impl.PersonImpl#getGarbage <em>
 * Garbage</em>}</li>
 * </ul>
 * </p>
 * 
...
public class PersonImpl extends EObjectImpl implements Person {
    ...
    /**
     * The cached value of the '{@link #getPhoneNumbers()
     * <em>Phone Numbers</em>}' containment reference list. <!-- begin-user-doc
     * --> <!-- end-user-doc -->
     * 
     * @see #getPhoneNumbers()
     * @generated
    ...
    /**
     * The default value of the '{@link #getTemperature() <em>Temperature</em>}'
     * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
     * 
     * @see #getTemperature()
     * @generated
    ...
    /**
     * The cached value of the '{@link #getGarbage() <em>Garbage</em>}'
    ...
    public void setFirstName(String newFirstName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AddressbookPackage.PERSON__FIRST_NAME, oldFirstName,
                    firstName));
    }
    ...
    public void setLastName(String newLastName) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AddressbookPackage.PERSON__LAST_NAME, oldLastName, lastName));
    }
    ...
    public EList<PhoneNumber> getPhoneNumbers() {
        if (phoneNumbers == null) {
            phoneNumbers = new EObjectContainmentEList<PhoneNumber>(
                    PhoneNumber.class, this,
                    AddressbookPackage.PERSON__PHONE_NUMBERS);
        }
        return phoneNumbers;
    }
    ...
    public EList<Score> getScores() {
        if (scores == null) {
            scores = new EObjectResolvingEList<Score>(Score.class, this,
                    AddressbookPackage.PERSON__SCORES);
        }
        return scores;
    }
    ...
    public void setTemperature(double newTemperature) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AddressbookPackage.PERSON__TEMPERATURE, oldTemperature,
                    temperature));
    }
            ...
            if (garbage != oldGarbage) {
                if (eNotificationRequired())
                    eNotify(new ENotificationImpl(this, Notification.RESOLVE,
                            AddressbookPackage.PERSON__GARBAGE, oldGarbage,
                            garbage));
            }
        }
        return garbage;
    ...
    public void setGarbage(Garbage newGarbage) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AddressbookPackage.PERSON__GARBAGE, oldGarbage, garbage));
    }
    ...
    public NotificationChain eInverseRemove(InternalEObject otherEnd,
        ...
        case AddressbookPackage.PERSON__PHONE_NUMBERS:
            return ((InternalEList<?>) getPhoneNumbers()).basicRemove(otherEnd,
                    msgs);
        }
    ...
    public void eSet(int featureID, Object newValue) {
        ...
        case AddressbookPackage.PERSON__PHONE_NUMBERS:
            ...
            getPhoneNumbers().addAll(
                    (Collection<? extends PhoneNumber>) newValue);
            return;
        case AddressbookPackage.PERSON__SCORES:
            getScores().clear();
