 ...
 * <ul>
 * <li>{@link org.example.emfdb.addressbook.impl.PhoneNumberImpl#getNumber <em>
 * Number</em>}</li>
 * <li>{@link org.example.emfdb.addressbook.impl.PhoneNumberImpl#getPriority
 * <em>Priority</em>}</li>
 * </ul>
 * </p>
 * 
...
public class PhoneNumberImpl extends EObjectImpl implements PhoneNumber {
    ...
    public void setNumber(String newNumber) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AddressbookPackage.PHONE_NUMBER__NUMBER, oldNumber, number));
    }
    ...
    public void setPriority(int newPriority) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET,
                    AddressbookPackage.PHONE_NUMBER__PRIORITY, oldPriority,
                    priority));
    }
