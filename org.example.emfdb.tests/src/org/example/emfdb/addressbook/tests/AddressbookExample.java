...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>addressbook</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class AddressbookExample {
	...
	public static void main(String[] args) {
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.addressbook"));
				Person root = AddressbookFactory.eINSTANCE.createPerson();
